...
export const MOCK_DELIVERY_DETAILS: Record<string, DriverDeliveryDetail> = {
  'SH-a8f3r7v2': {
    ...
    pickupName: 'City Logistics Hub',
    pickupAddress: '2200 S Western Ave, Dock B4, Chicago, IL 60608',
    pickupPhone: '+1 (312) 555-0100',
  ...
  'SH-782x90k1': {
    ...
    pickupName: 'TechHub Distribution Center',
    pickupAddress: '501 Commerce Way, North Sector, Springfield, IL 62701',
    pickupPhone: '+1 (217) 555-0050',
