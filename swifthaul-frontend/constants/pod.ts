...
export const POD = {
  ...
  PRO_TIP_TEXT:    'Good lighting helps avoid delivery disputes. Avoid blurry shots or heavy shadows.',
  COMPLETE_NAV:    'COMPLETE DELIVERY',
  REPORT_NAV:      'REPORT ISSUE',
  ORDER_ID_LABEL:  'ORDER ID:',

  // Signature step
  SIG_TITLE:       'Recipient Signature',
  SIG_SUBTITLE:    'Optional — ask the recipient to sign below',
  SIG_ORDER_LABEL: 'ORDER ID',
  SIG_RECIP_LABEL: 'RECIPIENT',
  SIG_PLACEHOLDER: 'SIGN ABOVE THE LINE',
  SIG_CLEAR:       'Clear',
  SIG_SKIP:        'Skip Signature',
  BACK_TO_PHOTO:   'Back to Photo',
  CONFIRM_DELIVERY:'Confirm Delivery',

  // Confirmation step
  CONF_TITLE:       'Delivery Confirmed!',
  CONF_SUBTITLE:    'The recipient has successfully signed and the proof of delivery has been uploaded to the system.',
...
export const FAIL_REASONS: { key: FailReason; label: string; icon: LucideIcon }[] = [
