...
export default function AcceptInvitePage({
  ...
  const onSubmit = (data: AcceptInviteFormData) => {
    acceptInvite.mutate({ ...data, token });
  };
      ...
      <div className="w-full max-w-md flex flex-col gap-6">
        ...
        <div className="auth-card">
          ...
          <div className="flex items-start justify-between mb-1">
            <h1 className="text-2xl font-bold text-[#0F2B46]">
          ...
          >
            ...
            <div className="form-field">
              <Label
                ...
                className="text-sm font-medium text-[#1E293B]"
              >
                {ACCEPT_INVITE.VEHICLE_TYPE_LABEL}
              </Label>
              <select
                id="vehicleType"
                className="input"
              ...
              >
                <option value="" disabled>
                  {ACCEPT_INVITE.VEHICLE_TYPE_PLACEHOLDER}
                </option>
              ...
              {errors.vehicleType && (
                <p className="field-error">{errors.vehicleType.message}</p>
              )}
            </div>
            ...
            <div className="form-field">
              <Label
                ...
                className="text-sm font-medium text-[#1E293B]"
              >
                {ACCEPT_INVITE.VEHICLE_PLATE_LABEL}
              </Label>
              <Input
                id="vehiclePlate"
                type="text"
                placeholder={ACCEPT_INVITE.VEHICLE_PLATE_PLACEHOLDER}
                autoComplete="off"
                {...register('vehiclePlate')}
              />
              {errors.vehiclePlate ? (
                <p className="field-error">{errors.vehiclePlate.message}</p>
              ) : (
                <p className="text-xs text-[#64748B] mt-1">
                  Vehicle type and plate are required for driver accounts.
                </p>
              )}
            </div>
